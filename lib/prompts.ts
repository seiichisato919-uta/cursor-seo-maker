...
## ⚠️【超重要】タスクの説明⚠️
あなたのタスクは以下の通りです：
1. **記事内容を読んで、セールス文を挿入すべき箇所を選ぶ（必ず1つ以上選ぶ）**
2. **既存の記事・文章を一切改変せず、選んだ箇所に「※ここにセールス文を書く」を挿入する（必ず挿入する）**
3. **「※ここにセールス文を書く」を1つも挿入しない場合は、タスクが完了していません**
...
- **セールス文を挿入すべき箇所が1つもない場合は、最も適切と思われる箇所に1つ以上挿入してください（必ず挿入する）**

## ⚠️【超重要】「※ここにセールス文を書く」の挿入方法⚠️
- **既存の文章の途中や文末など、自然な箇所に「※ここにセールス文を書く」を挿入してください**
- **「※ここにセールス文を書く」は既存の文章の前後に入れてください**
- **「※ここにセールス文を書く」は1つの段落に1〜3個程度を目安にしてください**
- **必ず1つ以上の「※ここにセールス文を書く」を挿入してください（1つも挿入しない場合はNG）**
- **挿入例：**
...
出力する前に、必ず以下を確認してください：
1. **既存の記事内容が一字一句そのまま保持されているか**
2. **「※ここにセールス文を書く」が1つ以上挿入されているか**
3. **「※ここにセールス文を書く」が適切な箇所に挿入されているか**
4. **分析結果やメッセージが含まれていないか**

**「※ここにセールス文を書く」が1つも含まれていない場合は、出力として不適切です。必ず「※ここにセールス文を書く」を挿入してください。**`;
}
